<form id="mprm-shortcode-form" data-selector="shortcode-form">
	<div class="mprm-line" data-selector="data-line">
		<div class="mprm-left-side"><?php esc_html_e('Shortcode type', 'mp-restaurant-menu'); ?></div>
		<div class="mprm-right-side">
			<select name="shortcode_name" data-selector="shortcode_name">
				<option value="mprm_categories"><?php esc_html_e('Show categories', 'mp-restaurant-menu'); ?></option>
				<option value="mprm_items"><?php esc_html_e('Show menu items', 'mp-restaurant-menu'); ?></option>
			</select>
		</div>
	</div>
	...
	<div class="mprm-line mprm-hidden" data-selector="data-line">
		<div class="mprm-left-side"><?php esc_html_e('Overlay color', 'mp-restaurant-menu'); ?></div>
		<div class="mprm-right-side">
			<input type="text" name="overlay_color" class="spectrum" data-selector="form_data" value="rgba(0, 0, 0, 0)"/>
		</div>
	</div>
	<div class="mprm-line mprm-hidden" data-selector="data-line">
		<div class="mprm-left-side"><?php esc_html_e('Hover color', 'mp-restaurant-menu'); ?></div>
		<div class="mprm-right-side">
			<input type="text" name="hover_color" class="spectrum" data-selector="form_data" value="rgba(0, 0, 0, 0)"/>
		</div>
	</div>
	<div class="mprm-line mprm-hidden" data-selector="data-line">
		<div class="mprm-left-side"><?php esc_html_e('Text color', 'mp-restaurant-menu'); ?></div>
		<div class="mprm-right-side">
	...
	<div class="mprm-line" data-selector="data-line">
		<input class="button button-primary button-large" type="button" data-selector="insert_shortcode" value="<?php esc_html_e('Insert shortcode', 'mp-restaurant-menu'); ?>"/>
	</div>
</form>