<tr class="form-field">
	<th for="category-order"><?php esc_html_e('Order', 'mp-restaurant-menu'); ?></th>
	<td id='menu-cat-order'>
		<input type="text" id="category-order" value="<?php echo esc_attr($order); ?>" name="term_meta[order]"/>
	</td>
</tr>
<tr class="form-field">
	<th scope="row" valign="top"><label for="term_meta[iconname]"><?php esc_html_e('Icon', 'mp-restaurant-menu'); ?></label></th>
	<td id='menu-cat-icon'>
...
<tr class="form-field">
	<th scope="row" valign="top"><label><?php esc_html_e('Thumbnail', 'mp-restaurant-menu'); ?></label></th>
	<td>
		...
		<button type="submit" class="upload_image_button button"><?php esc_html_e('Set Image', 'mp-restaurant-menu'); ?></button>
		<button type="submit" class="remove_image_button button"><?php esc_html_e('Remove', 'mp-restaurant-menu'); ?></button>
		<div class="clear"></div>
	</td>
</tr>