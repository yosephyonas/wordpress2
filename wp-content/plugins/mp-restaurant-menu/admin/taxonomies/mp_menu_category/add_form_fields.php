<div class="form-field" id='fp_icon_field'>
	<label for="category-order"><?php esc_html_e('Order', 'mp-restaurant-menu'); ?></label>
	<input type="text" id="category-order" name="term_meta[order]"/>
</div>
<div class="form-field" id='fp_icon_field'>
	<label for="IconPicker"><?php esc_html_e('Icon', 'mp-restaurant-menu'); ?>
	</label>
	<input type="text" id="IconPicker" name="term_meta[iconname]"/>
</div>
<div class="form-field">
	<label><?php esc_html_e('Thumbnail', 'mp-restaurant-menu'); ?></label>
	...
	<button type="button" class="upload_image_button button"><?php esc_html_e('Set Image', 'mp-restaurant-menu'); ?></button>
	<button type="button" class="remove_image_button button"><?php esc_html_e('Remove', 'mp-restaurant-menu'); ?></button>
	<div class="clear"></div>
</div>
