<div class="mprm-nutritional-values">
	<p>
		<label><?php esc_html_e('Calories', 'mp-restaurant-menu'); ?>:</label> <br/>
	...
	<p>
		<label><?php esc_html_e('Cholesterol', 'mp-restaurant-menu'); ?>:</label><br/>
	...
	<p>
		<label><?php esc_html_e('Fiber', 'mp-restaurant-menu'); ?>:</label> <br/>
	...
	<p>
		<label><?php esc_html_e('Sodium', 'mp-restaurant-menu'); ?>:</label><br/>
	...
	<p>
		<label><?php esc_html_e('Carbohydrates', 'mp-restaurant-menu'); ?>:</label><br/>
	...
	<p>
		<label><?php esc_html_e('Fat', 'mp-restaurant-menu'); ?>:</label><br/>
	...
	<p>
		<label><?php esc_html_e('Protein', 'mp-restaurant-menu'); ?>:</label><br/>
