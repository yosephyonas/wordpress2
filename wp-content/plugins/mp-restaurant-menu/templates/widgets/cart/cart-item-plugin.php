...
<li class="mprm-cart-item">
	...
	<a href="{remove_url}" data-cart-item="{cart_item_id}" data-menu-item-id="{item_id}" data-action="mprm_remove_from_cart" class="mprm-remove-from-cart mprm-plugin-mode"><?php esc_html_e('remove', 'mp-restaurant-menu'); ?></a>
